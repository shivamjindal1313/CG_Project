...
void draw_circle(GLint h, GLint k, GLint r) //mid point
{
	GLint d=1-r, x=0, y=r;
	while(y>x)
	{
...
if(light==1)  //value of i when first vehicle is near the traffic-signal
 {
	 i-=SPEED/10;
     ++m;
	n-=2;
...
int c_menu;
	...
	glutCreateWindow("Urban State Scenario");
	myinit();
